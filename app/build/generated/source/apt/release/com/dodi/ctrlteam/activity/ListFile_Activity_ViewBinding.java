...
public class ListFile_Activity_ViewBinding implements Unbinder {
  private ListFile_Activity target;

  @UiThread
  public ListFile_Activity_ViewBinding(ListFile_Activity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ListFile_Activity_ViewBinding(ListFile_Activity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ListFile_Activity target = this.target;
