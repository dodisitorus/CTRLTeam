...
public class PendingProjectFragment_ViewBinding implements Unbinder {
  private PendingProjectFragment target;

  @UiThread
  public PendingProjectFragment_ViewBinding(PendingProjectFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    PendingProjectFragment target = this.target;
