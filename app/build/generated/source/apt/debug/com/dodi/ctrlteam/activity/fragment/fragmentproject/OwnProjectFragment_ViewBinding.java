...
public class OwnProjectFragment_ViewBinding implements Unbinder {
  private OwnProjectFragment target;

  @UiThread
  public OwnProjectFragment_ViewBinding(OwnProjectFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    OwnProjectFragment target = this.target;
