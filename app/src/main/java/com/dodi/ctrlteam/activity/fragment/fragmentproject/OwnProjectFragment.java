...
public class OwnProjectFragment extends Fragment implements BubbleAdapter.BubbleAdapterCallback {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_project_own, container, false);
