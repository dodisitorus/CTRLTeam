...
class SearchHolder extends RecyclerView.ViewHolder {
    ...
    void bindContent(IRainbowContact contact, Context context, List<IRainbowContact> chooses) {
        ...
        // show icon checked on list
        ImageView iconCheck = itemView.findViewById(R.id.icon_correct);
        if (chooses.contains(contact)) {
            iconCheck.setVisibility(View.VISIBLE);
        } else {
            iconCheck.setVisibility(View.GONE);
        }

        // create avatar contact
